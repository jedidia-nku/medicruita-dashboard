...
const PendingKYCTable: React.FC = () => {
    return (
                ...
                <div className="inline-block align-middle w-full">
                    <div className="overflow-hidden border rounded-lg border-gray-300 font-inter">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white py-5 px-4 sm:px-5">
                            <span className="text-lg text-[#1E1E1ECC]">Users Awaiting KYC Verification</span>
                            ...
                            <table className="table-auto w-full">
                                ...
                                <thead className="hidden sm:table-header-group">
                                    <tr className="bg-gray-50 h-[40px]">
                                        ...
                                        <th className="px-3 py-2 text-left text-sm font-semibold text-[#4F5144]"> KYC </th>
                                        <th className="px-3 py-2 text-left text-sm font-semibold text-[#4F5144]"> Submission Date</th>
                                    </tr>
                                </thead>
                                        ...
                                        <tr key={user.id} className="bg-white transition-all duration-500 hover:bg-gray-50">
                                            ...
                                            <td className="px-3 py-2 hidden sm:table-cell">
                                                <div className="flex items-center gap-3">
                                                    <p className="text-sm text-[#1E1E1EBF]">{user.name}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-3 py-2 hidden sm:table-cell text-sm text-[#1E1E1EBF]">{user.phone}</td>
                                            <td className="px-3 py-2 hidden sm:table-cell font-semibold text-sm text-[#1E1E1EBF]">{user.kyc}</td>
                                            <td className="px-3 py-2 hidden sm:table-cell text-sm text-[#1E1E1EBF]">{user.submissionDate}</td>
                                            ...
                                            <td className="px-4 py-4 sm:hidden">
                                                <div className="flex flex-col space-y-2">
                                                    ...
                                                    <div className="flex justify-between text-sm text-gray-600">
                                                        <span>KYC:</span>
                                                        <span className="font-semibold">{user.kyc}</span>
                                                    </div>
                                                    <div className="flex justify-between text-sm text-gray-600">
                                                        <span>Submission Date:</span>
                                                        <span className="font-semibold">{user.submissionDate}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
